...
export class AssetPipeline {
  ...
  constructor(options: PipelineOptions = {}) {
    ...
    this.fal = new FalService({ apiKey: options.apiKey, proxyUrl: options.proxyUrl });
  }
  ...
  private async processVariants(tempDir: string, trackingData: SubjectFrameData[], options: { step: number, hasDepth: boolean, variants: VariantConfig[], outDir: string }) {
